<section class="p-6 w-full">
    @if ($orders->empty())
        <div class="text-center pt-5">
            ...
            <a class="py-3 px-4  bg-green-600 rounded-lg hover:bg-green-500 text-white transition-colors" href="{{ route('home') }}">
                перейти на головну
            </a>
        </div>
    @else
                ...
                @foreach ($orders as $order)
                    <li wire:key='{{ $order->id }}' class="bg-white shadow-lg rounded-lg p-6 relative">
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            @endif
                            <div>
                                <p class="text-lg font-semibold text-blue-500">Загальна сума: {{ $order->amount }} грн
                                </p>
                            </div>
                        </div>
                    </li>
