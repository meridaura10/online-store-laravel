    ...
    public function run(): void
    {
        $data = [
            ...
            'Процесор' => [
                ...
                'Процecор' => ['Шестиядерний AMD Ryzen 5 5625U (2.3 - 4.3 ГГц)', 'Процессор AMD Ryzen 7 5700X 3.4(4.6)GHz 32MB sAM4 Box (100-100000926WOF)', 'Процесор Intel Core i9-13900K 3.0GHz/36MB (BX8071513900K) s1700 BOX'],
            ],
        ];
        ...
        foreach ($data as $title => $subs) {
            ...
            foreach ($subs as $title => $values) {
                ...
                $categories = Category::query()->inRandomOrder()->where('parent_id', '!=', null)->limit(8)->get();
